...
#U2
blues3 = Routine.create(user_id: jon3.id, name: "Blues 3", description: "Collection of blues exercises", image: "https://image.pbs.org/poster_images/assets/SF_121_TN_Is-Blues-the-Mother-of-All-Modern-Music_PBSLearning.jpg")
songs3 = Routine.create(user_id: jon3.id, name: "Songs 3", description: "Songs to practice", image: "https://preview.redd.it/npq5bdmd9qi41.jpg?auto=webp&s=0c18b3e6e5de2d3b95144e13702c90363ef0acb1")
chords3 = Routine.create(user_id: jon3.id, name: "Chords 3", description: "Some interesting chord shapes", image: "https://wallpaperbat.com/img/278205-music-sheet-wallpaper.jpg")
...
nito3 = Exercise.create(routine_id: songs3.id, name: "Homesick 3", bpm: 84, description: "Another Ichika Nito one", video_url: "https://www.youtube.com/watch?v=ZUxFFH3Aekg", notes: "COOL.", is_private: true)
castles3 = Exercise.create(routine_id: songs3.id, name: "Castles Made of Sand 3", bpm: 94, description: "Hendrix Cover", video_url: "https://www.youtube.com/watch?v=VjWt79eNyMM&t=15s", notes: "Yes.", is_private: true)
paul_chords3 = Exercise.create(routine_id: chords3.id, name: "Some Chords 3", bpm: 120, description: "Paul Davids - Chords and Progressions", video_url: "https://www.youtube.com/watch?v=K_T-jYyQCbQ", notes: "Switching up some basic chord shapes", is_private: true)
ichika3 = Exercise.create(routine_id: chords3.id, name: "Some more chords 3", bpm: 120, description: "Ichika again?", video_url: "https://www.youtube.com/watch?v=qBTYkNZw5g8", notes: "Ichika again.", is_private: true)
progressions3 = Exercise.create(routine_id: chords3.id, name: "Chord Progressions Tutorial 3", bpm: 120, description: "Tips on writing better chord progressions (with theory!)", video_url: "https://www.youtube.com/watch?v=ZlYlg0y_8mA", notes: "Have the circle of fifths handy", is_private: true)
